...
/*
  ...
  - `forEach()`: Ejecuta una función proporcionada una vez la condición por cada elemento del array.
  - `map()`: Crea un nuevo array con los resultados de la llamada a la función proporcionada en cada elemento del array.
  - `filter()`: Crea un nuevo array con todos los elementos que cumplan  implementada por la función proporcionada.
